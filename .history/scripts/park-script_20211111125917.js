...
$(window).load(function () {
  ...
  swing.addEventListener("onmouseenter", function(){  swingFX.play();}, false);
  hopscotch.addEventListener("onmouseenter", function(){ hopscotchFX.play();}, false);
  playing.addEventListener("onmouseenter", function(){ childrenFX.play();}, false);
});