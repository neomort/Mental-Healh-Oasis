...
$(window).load(function () {
  ...
  swing.addEventListener("mouseenter", function(){  swingFX.play();}, false);
  swing.addEventListener("mouseenter", function(){ hopscotchFX.play();}, false);
  swing.addEventListener("mouseenter", function(){ childrenFX.play();}, false);
});